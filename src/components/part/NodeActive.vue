...
<script>
    export default {
        ...
        computed: {
            nodeTypeName() {
                return {"1": "战斗点", "2": "BOSS点", "3": "资源点", "4": "待机点", "5": "收费站", "10": "航空点", "11": "BOSS点"}[this.nodeType.toString()]
            },
            nodeTypeColor() {
                return {"1": "", "2": "danger", "3": "success", "4": "info", "5": "warning", "10": "", "11": "danger"}[this.nodeType.toString()]
            }
        }
    }
</script>
